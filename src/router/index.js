...
export const asyncRouterMap = [
  {
    ...
    children: [{
    ...
    },
      {
        ...
        meta: {title: 'Adding Products', icon: 'product-add'}
      },
      {
        path: 'updateProduct',
        name: 'updateProduct',
      ...
      },
      {
        ...
        meta: {title: 'Edit product attributes'},
        hidden: true
      },
      {
        path: 'brand',
        ...
        meta: {title: 'Product Brands', icon: 'product-brand'}
      },
      {
        path: 'addBrand',
        name: 'addBrand',
  ...
  },
  {
    ...
    redirect: '/oms/order',
    name: 'oms',
    meta: {title: 'Order Form', icon: 'order'},
    children: [
      {
        path: 'order',
        name: 'order',
  ...
  },
  {
    ...
    redirect: '/sms/coupon',
    name: 'sms',
    meta: {title: 'Sale', icon: 'sms'},
    children: [
      {
        path: 'flash',
        name: 'flash',
        component: () => import('@/views/sms/flash/index'),
        meta: {title: 'Flash Promotion activity list', icon: 'sms-flash'}
      },
      {
        path: 'flashSession',
        name: 'flashSession',
        component: () => import('@/views/sms/flash/sessionList'),
        meta: {title: 'Flash Promotion time period list'},
        hidden: true
      },
      {
        path: 'selectSession',
        ...
        meta: {title: 'Flash Promotion time period selection'},
        hidden: true
      },
      {
        ...
        meta: {title: 'Flash Promotion product list'},
        hidden: true
      },
      {
        path: 'coupon',
      ...
      },
      {
        ...
        meta: {title: 'Recommended subject', icon: 'sms-subject'}
      },
      {
        path: 'advertise',
        name: 'homeAdvertise',
  ...
  },
  {
    ...
    redirect: '/ums/admin',
    name: 'ums',
    meta: {title: 'Administration', icon: 'ums'},
    children: [
      {
        path: 'admin',
        name: 'admin',
      ...
      },
      {
        ...
        meta: {title: 'Resource Category List'},
        hidden: true
      }
    ]
  },
